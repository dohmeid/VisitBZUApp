...
public class SaraIssaComputerEngineeringMaster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sara_issa_activity_computer_engineering_master);
        ...
        DocumentReference docRef = db.collection("FacultyOfInformationTechnologyPrograms").document("ComputerEngineeringMaster");
