...
public class SaidKhouryLibraryForDevelopmentStudies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_said_khoury_library_for_development_studies);
        ...
        docRef = db.collection("InformationAboutBuildings").document("TheCenterForDevelopmentStudiesLibrary");
        ...
        location.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                intent = new Intent(SaidKhouryLibraryForDevelopmentStudies.this, sararom_Map.class);
